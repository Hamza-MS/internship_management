...
import 'liste_etablissement_model.dart';
export 'liste_etablissement_model.dart';

class ListeEtablissementWidget extends StatefulWidget {
  const ListeEtablissementWidget({Key? key}) : super(key: key);

  @override
  _ListeEtablissementWidgetState createState() =>
      _ListeEtablissementWidgetState();
}

class _ListeEtablissementWidgetState extends State<ListeEtablissementWidget>
    with TickerProviderStateMixin {
  late ListeEtablissementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListeEtablissementModel());
