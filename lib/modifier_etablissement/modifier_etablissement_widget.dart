...
import 'modifier_etablissement_model.dart';
export 'modifier_etablissement_model.dart';

class ModifierEtablissementWidget extends StatefulWidget {
  const ModifierEtablissementWidget({Key? key}) : super(key: key);

  @override
  _ModifierEtablissementWidgetState createState() =>
      _ModifierEtablissementWidgetState();
}

class _ModifierEtablissementWidgetState
    extends State<ModifierEtablissementWidget> with TickerProviderStateMixin {
  late ModifierEtablissementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModifierEtablissementModel());
                          ...
                          return DataTable2(
                            ...
                            rows: dataTableEtablissementRecordList
                                .mapIndexed((dataTableIndex,
                                    ...
                                    [
                                      StreamBuilder<List<EtablissementRecord>>(
                                        stream: queryEtablissementRecord(),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
