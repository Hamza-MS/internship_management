...
import 'add_etablissement_copy_model.dart';
export 'add_etablissement_copy_model.dart';

class AddEtablissementCopyWidget extends StatefulWidget {
  const AddEtablissementCopyWidget({Key? key}) : super(key: key);

  @override
  _AddEtablissementCopyWidgetState createState() =>
      _AddEtablissementCopyWidgetState();
}

class _AddEtablissementCopyWidgetState extends State<AddEtablissementCopyWidget>
    with TickerProviderStateMixin {
  late AddEtablissementCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddEtablissementCopyModel());
